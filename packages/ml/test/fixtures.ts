...
import type { MarketSnapshot, RecommendationSnapshot } from "../src/types.js";

export function recommendationFixture() {
  return structuredClone(recommendationFixtureJson) as unknown as RecommendationSnapshot;
}
